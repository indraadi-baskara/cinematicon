		...
		<div>
			<section className="text-gray-700 body-font overflow-hidden ">
				<div className="container px-5 py-6 mx-auto">
					<div className="lg:w-4/5 mx-auto p-6 flex flex-wrap bg-white">
						<img
							alt="ecommerce"
							style={{ height: "35rem" }}
							className="lg:w-2/5 w-full object-cover object-center rounded border border-gray-200 shadow-inner"
							src={movie.Poster}
						/>
